          ...
          <div class="box-header">
            ...
            <div class="btn-group pull-right">            
              ...
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> &nbsp Tambah Program
              </button>
            </div>
          </div>
          <div class="box-body">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="kategori" required="required" class="form-control" placeholder="Dana BOS ..">
                      </div>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%">
                                    <label>Nama Program</label>
                                    <input type="hidden" name="id" required="required" class="form-control" placeholder="Nama Program .." value="<?php echo $d['kategori_id']; ?>">
                                    <input type="text" name="kategori" required="required" class="form-control" placeholder="Nama Program .." value="<?php echo $d['kategori']; ?>" style="width:100%">
                                  </div>
