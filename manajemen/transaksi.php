                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="keterangan" class="form-control" placeholder="SILAHKAN DIKOSONGKAN" rows="3"></textarea>
                      </div>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <!-- <th rowspan="2" class="text-center">ID REKENING</th> -->
                ...
                <tbody>
                  ...
                  $sqll = "SELECT * FROM transaksi,kategori where kategori_id=transaksi_kategori order by transaksi_id desc";
                  if($_SESSION['id']!=1) {
                    $sqll = "SELECT * FROM transaksi,kategori where user_id='".$_SESSION['id']."' AND kategori_id=transaksi_kategori order by transaksi_id desc";
                  }

                  $data = mysqli_query($koneksi, $sqll);
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td><?php echo getUser($d['user_id']); ?></td>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    <label>ID Rekening</label><br><b>TIDAK BOLEH DIRUBAH</b>
                                    <textarea name="keterangan" style="width:100%" class="form-control" placeholder="SILAHKAN DIKOSONGKAN" rows="4"><?php echo $d['transaksi_bank'] ?></textarea>
                                  </div>
