...
if($filename == ""){
	$sqll = "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori','$nominal','$keterangan','','$bank','$user_id')";
	mysqli_query($koneksi, $sqll)or die(mysqli_error($koneksi));
	...
	if(!in_array($ext,$allowed) ) {
		...
		$sqll = "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori','$nominal','$keterangan','$file_gambar','$bank','$user_id')";
